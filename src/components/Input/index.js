...
import { TextInput, View, Text, Pressable, Image, Modal, TouchableWithoutFeedback, Touchable, TouchableOpacity } from "react-native";
        ...
        <View style={styles.container}>
            ...
            {type === 'picker' ? (
                <Pressable onPress={() => setPickerModalVisible(true)} style={styles.inputContainer}>
                    { value ? ( <Text style={[styles.placeholder, style]}>{placeholder}</Text>
                    ) : (
                ...
                <View style={styles.inputContainer}>
                    <TextInput value={value} onChangeText={onChangeText} secureTextEntry={isPassword && !isPasswordVisible} placeholder={placeholder} style={[styles.input]} {...props} />
                    {
                    isPassword ? (
